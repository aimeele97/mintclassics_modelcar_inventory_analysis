...
SELECT 'warehouses' AS table_name, COUNT(*) AS total_records
    FROM warehouses 
UNION ALL SELECT 'product', COUNT(*)
    FROM products 
UNION ALL SELECT 'productlines', COUNT(*)
    FROM productlines 
UNION ALL SELECT 'orders', COUNT(*)
    FROM orders 
UNION ALL SELECT 'orderdetails', COUNT(*)
    FROM orderdetails 
UNION ALL SELECT 'customers', COUNT(*)
    FROM customers 
UNION ALL SELECT 'payments', COUNT(*)
    FROM payments 
UNION ALL SELECT 'employees', COUNT(*)
    FROM employees 
UNION ALL SELECT 'offices', COUNT(*)
    FROM offices;
